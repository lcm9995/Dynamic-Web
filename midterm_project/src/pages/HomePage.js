...
const HomePage = () => {
    ...
    const openSpotify = () => {
        window.open("https://open.spotify.com/artist/77zJxEC29DLX2zTb2PHCLr?si=PNhdxVH8QTWO8mW1reBOjQ", "_blank");
    }
    const openAppleMusic = () => {
        window.open("https://music.apple.com/ng/artist/joeyori/1500432802", "_blank");
    }
    ...
    return (
            <div className="home-pg">
                {showInfo && (<div className="window-spot" style={{ top: 40, left: 32 }}>
                    <Window type="message" messageText="About the artist" onClose={closeInfo}/>
                </div>)}
                {showImage && (<div className="window-spot" style={{ top: 50, right: 400 }}>
                    <Window type="image" mediaSrc={currentImageSrc} title={currentImageTitle} onClose = {closeImage} />
                </div>)}
                {showVideo && (<div className="window-spot" style={{ top: 320, left: 120 }}>
                    <Window type="media" mediaType="video" mediaSrc={currentVideoSrc} title ={currentVideoTitle} onClose={closeVideo}/>
                </div>)}
                ...
                <div className="app-icons-container">
                    ...
                    <AppIcon label = "About" iconSrc = {infoIcon} onDoubleClick={openInfo} />
                    <AppIcon label = "Spotify" iconSrc = {spotifyIcon} onDoubleClick={openSpotify} />
                    <AppIcon label = "Apple Music" iconSrc = {applemusicIcon} onDoubleClick={openAppleMusic} />
                </div>
